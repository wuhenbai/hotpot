...
from model.GNN import BertForQuestionAnswering, GraphFusionNet, DFGN_Albert
from transformers import RobertaTokenizer, AlbertTokenizer, AdamW

from create_graph import iter_data
from util import evaluate
from hotpot_evaluate_v1 import eval
from config_roberta import set_config
...
def main():
    ...
    model = DFGN_Albert.from_pretrained(r'/DATA/disk1/baijinguo/BERT_Pretrained/albert-xlarge-v2', graph_config=args)
    model.to(device)
    model.train()
