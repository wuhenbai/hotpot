...
class SquadExample(object):
    ...
    def __init__(
        ...
        if is_train:
            if not is_impossible:
                doc_tokens = [context_text[:start_position_character],
                              context_text[start_position_character: start_position_character + answer_length],
                              context_text[start_position_character + answer_length:]]
                start_pos = 1
                end_pos = 1

        else:
            doc_tokens = tokenize_chinese_chars(context_text)
...
if __name__=="__main__":
    ...
    examples = processor.get_train_examples(r"E:\DATA\Squad")
