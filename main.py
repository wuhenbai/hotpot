...
path = "/DATA/disk1/baijinguo/DATA/hotpotQA"
glove_word_file = os.path.join(path, "glove.840B.300d.txt")

word_emb_file = os.path.join(path, "word_emb.json")
char_emb_file = os.path.join(path, "char_emb.json")
train_eval = os.path.join(path, "train_eval.json")
dev_eval = os.path.join(path, "dev_eval.json")
test_eval = os.path.join(path, "test_eval.json")
word2idx_file = os.path.join(path, "word2idx.json")
char2idx_file = os.path.join(path, "char2idx.json")
idx2word_file = os.path.join(path, 'idx2word.json')
idx2char_file = os.path.join(path, 'idx2char.json')
train_record_file = os.path.join(path, 'train_record.pkl')
dev_record_file = os.path.join(path, 'dev_record.pkl')
test_record_file = os.path.join(path, 'test_record.pkl')
